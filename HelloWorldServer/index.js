...
app.post('/', (req, res) => {
    ...
    req.on('data', function(chunk) {
      ...
      // cannot run this under DS as no tsjf
      // but may be possible under linux with CUDA even 
      // run();    
...
app.get('/dnirisClassifierNoGood', (req, res) => {
    res.sendFile('./ts_deployment_myExercise/dniris-classifier.html', { root: __dirname });
});

app.use('/ai', express.static('ts_deployment_myExercise'));
